...
```tsx filename="app/api/v1/chat/route.ts" highlight="7-25,32-37"
import {
...
```tsx filename="app/api/v1/chat/route.ts" highlight="3,10-24"
import {
  convertToModelMessages,
  streamText,
  validateUIMessages,
...
```tsx filename="app/api/v1/chat/route.ts" highlight="6,11-17"
import { openai } from "@ai-sdk/openai";
...
```tsx filename="app/api/v1/chat/route.ts" highlight="7-11"
...
```tsx filename="app/api/v1/chat/route.ts" highlight="8-18"
import {
  generateId,
  streamText,
...
```tsx filename="app/api/v1/chat/route.ts" highlight="2-11,14-18"
...
```tsx filename="app/api/v1/chat/route.ts" highlight="19-21"
import { convertToModelMessages, streamText, UIMessage } from "ai";
import { saveChat } from "@util/chat-store";
